...
```bash
/home/jiutian/my_reproduction/DRL-robot-navigation-main
```

常用脚本：

- Python 环境激活脚本：
  `/home/jiutian/my_reproduction/DRL-robot-navigation-main/env.python.sh`
- ROS 安装脚本：
  `/home/jiutian/my_reproduction/DRL-robot-navigation-main/scripts/install_ros_noetic_system.sh`
- catkin 编译脚本：
  `/home/jiutian/my_reproduction/DRL-robot-navigation-main/scripts/build_readme_workspace.sh`
- 训练启动脚本：
...
```bash
sudo bash /home/jiutian/my_reproduction/DRL-robot-navigation-main/scripts/install_ros_noetic_system.sh
```
...
```bash
bash /home/jiutian/my_reproduction/DRL-robot-navigation-main/scripts/build_readme_workspace.sh
```

编译成功后，可用工作区为：

```bash
/home/jiutian/my_reproduction/DRL-robot-navigation-main/catkin_ws
```
...
```bash
source /home/jiutian/my_reproduction/DRL-robot-navigation-main/env.python.sh
```
...
```bash
bash /home/jiutian/my_reproduction/DRL-robot-navigation-main/scripts/run_readme_training.sh
```
...
```bash
bash /home/jiutian/my_reproduction/DRL-robot-navigation-main/scripts/start_training_detached.sh
```
...
```bash
tail -f /home/jiutian/my_reproduction/DRL-robot-navigation-main/logs/最新日志文件名
```
...
```bash
bash /home/jiutian/my_reproduction/DRL-robot-navigation-main/scripts/stop_training_detached.sh
```
...
```bash
/home/jiutian/my_reproduction/DRL-robot-navigation-main/TD3/runs
```
...
```bash
/home/jiutian/my_reproduction/DRL-robot-navigation-main/TD3/results
```
...
```bash
/home/jiutian/my_reproduction/DRL-robot-navigation-main/TD3/pytorch_models
```
...
```bash
/home/jiutian/my_reproduction/DRL-robot-navigation-main/TD3/checkpoints
```
...
source /home/jiutian/my_reproduction/DRL-robot-navigation-main/env.python.sh
source /opt/ros/noetic/setup.bash
cd /home/jiutian/my_reproduction/DRL-robot-navigation-main/catkin_ws
...
```bash
bash /home/jiutian/my_reproduction/DRL-robot-navigation-main/scripts/clean_training_artifacts.sh
```
