...
> 历史记录：本文档记录早期两车 Weighted08 机制验证。三车 Weighted08 历史对照请以 `experiments/01_第一次尝试/多智能体/3智能体/C_Weighted08距离加权奖励对照/README.md`、`三车Weighted08/` 和 `experiments/01_第一次尝试/多智能体/3智能体/三车主线对照总表.md` 为准。
