...
export DRL_MULTI_TEST_STATE_PATH="./checkpoints/dual_dense_test_state.pt"
export DRL_MULTI_TEST_STATS_PATH="./results/dual_dense_test.npy"

bash "$PROJECT_ROOT/scripts/start_test_detached_multi_curriculum.sh" \
  stage3_asym_three_5 \
  "$STANDARD_ACTOR"
